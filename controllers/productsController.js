...
const controller = {
    ...
    // Read - Muestra todas las publicaciones

    publications: async (req, res) => {
        const productos = await Productos.findAll({
            where: {
                usuarioId: req.session.usuarioLogueado.id,
            },
        ...
        res.render("publications", { productos });
    },
        ...
        try {
            ...
            switch (product.tipoproducto) {
                case 1:
                    ...
                    return res.render("detail_bebidas", {
                        product,
                        bebida,
                        presentacion,
                    });
        ...
        try {
            ...
            switch (product.tipoproducto) {
                case 1:
                    ...
                    return res.render("edit-bebidas", {
                        product,
                        bebida,
                        envase,
                    });
